...
msg.TheRank = 'Myth'
msg.Rank = 1
elseif redis:sismember(max..':VSUDO_BOT:',msg.sender_user_id_) then
msg.TheRankCmd = 'R H F'
msg.TheRank = 'R H F'
msg.Rank = 99
elseif redis:sismember(max..':MSUDO_BOT:',msg.sender_user_id_) then
msg.TheRankCmd = 'M 7 M D'
msg.TheRank = 'M 7 M D'
msg.Rank = 88
elseif redis:sismember(max..':FSUDO_BOT:',msg.sender_user_id_) then
msg.TheRankCmd = 'F S L'
msg.TheRank = 'F S L'
msg.Rank = 77
elseif redis:sismember(max..':ASUDO_BOT:',msg.sender_user_id_) then
msg.TheRankCmd = 'F W A L'
msg.TheRank = 'F W A L'
msg.Rank = 55
elseif redis:sismember(max..':PSUDO_BOT:',msg.sender_user_id_) then
msg.TheRankCmd = 'planet'
msg.TheRank = 'planet'
msg.Rank = 66
...
if msg.Rank == 1 or msg.Rank == 99 then
msg.SudoBaseV = true
end

if msg.Rank == 1 or msg.Rank == 99 or msg.Rank == 88 then
msg.SudoBaseM = true
end

if msg.Rank == 1 or msg.Rank == 99 or msg.Rank == 77 then
msg.SudoBaseF = true
end

if msg.Rank == 1 or msg.Rank == 99 or msg.Rank == 88 or msg.Rank == 77 or msg.Rank == 55 then
msg.SudoBaseA = true
end
...
if msg.Rank == 1 or msg.Rank == 2 or msg.Rank == 99 or msg.Rank == 88 or msg.Rank == 77 or msg.Rank == 55 then
msg.SudoUser = true
end

if msg.Rank == 1 or msg.Rank == 99 or msg.Rank == 2 or msg.Rank == 3 or msg.Rank == 88 or msg.Rank == 77 or msg.Rank == 55 then
msg.Kara = true
end

if msg.Rank == 1 or msg.Rank == 2 or msg.Rank == 99 or msg.Rank == 3 or msg.Rank == 4 or msg.Rank == 88 or msg.Rank == 77 or msg.Rank == 55 then
msg.Creator = true
end

if msg.Rank == 1 or msg.Rank == 2 or msg.Rank == 99 or msg.Rank == 3 or msg.Rank == 4 or msg.Rank == 5 or msg.Rank == 88 or msg.Rank == 77 or msg.Rank == 55 then
msg.Director = true
end

if msg.Rank == 1 or msg.Rank == 2 or msg.Rank == 99 or msg.Rank == 3 or msg.Rank == 4 or msg.Rank == 5 or msg.Rank == 6 or msg.Rank == 88 or msg.Rank == 77 or msg.Rank == 55 or msg.Rank == 66 then
msg.Admin = true
end
...
msg.text = Mohammad:gsub(Mohammad,mmdi)
	...
	function relaoding(msg) 
	
	sendMsg(msg.chat_id_,msg.id_,"- تم تحديث الملفات  -",nil,function(arg,data)
	Refresh_Start = true
	end)
	end
	
	
	if msg.text== 'Update Sourceddddddddddd' and msg.sender_user_id_ == SUDO_ID then
	download_file('https://raw.githubusercontent.com/MAXTELEE/MAX/master/inc/Run.lua','./inc/Run.lua')
	download_file('https://raw.githubusercontent.com/MAXTELEE/MAX/master/inc/Script.lua','./inc/Script.lua')
	download_file('https://raw.githubusercontent.com/MAXTELEE/MAX/master/inc/functions.lua','./inc/functions.lua')
	download_file('https://raw.githubusercontent.com/MAXTELEE/MAX/master/inc/locks.lua','./inc/locks.lua')
...
redis:hset(max..'username:'..tonumber(mmd),'username',msg.text)
	send_msg(msg.chat_id_,"-› اهلاً حبيبي تم تغيير الـMyth ارسل الأن ( تحديث M ) .")
	end
...
redis:setex('setid'..msg.sender_user_id_,120,true)
	...
	if msg.text== 'تحديث M' and msg.sender_user_id_ == SUDO_ID then
	sendMsg(msg.chat_id_,msg.id_,'- تم إعادة تشغيل البوت -',nil,function(arg,data)
	dofile("./inc/Run.lua")
	print("Reload ~ ./inc/Run.lua")
	end)
	return false
...
download(stk,32)
	...
	if redis:get(max..'group:add'..msg.chat_id_) and (msg.sender_user_id_ == SUDO_ID or redis:sismember(max..':VSUDO_BOT:',msg.sender_user_id_) or redis:sismember(max..':MSUDO_BOT:',msg.sender_user_id_) or redis:sismember(max..':FSUDO_BOT:',msg.sender_user_id_) or redis:sismember(max..':SUDO_BOT:',msg.sender_user_id_) or redis:sismember(max..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) or redis:sismember(max..'owners:'..msg.chat_id_,msg.sender_user_id_) or redis:sismember(max..'admins:'..msg.chat_id_,msg.sender_user_id_)) then
	msg.Admin = true
	end
	local lock_bots = redis:get(max..'lock_bots'..msg.chat_id_)
	ISBOT = false
...
kick_user(msg.sender_user_id_,msg.chat_id_)
	...
	send_msg(SUDO_ID,"-› تم طرد البوت من المجموعة\n- "..Flter_Markdown(NameGroup).." - \n- ايدي المجموعة:\n-100"..data.channel_.id_.."\n- البوت حذف كل بيانات المجموعة (: .")
