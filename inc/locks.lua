...
if not msg.Creator then return "-› هذا الامر يخص (نائب مدير, المدير، المالك، Dev) فقط ." end
...
return "-› أهلا عزيزي "..msg.TheRankCmd.."تم تفعيل التحذير."
end
end

function lock_YT(msg)
if not msg.Admin then return "-› هذا الامر يخص (نائب المدير, المدير، المالك) فقط ." end
if not redis:get(max..'lock_yt'..msg.chat_id_) then
return "-› أهلا عزيزي "..msg.TheRankCmd.." اليوتيوب بالتأكيد معطل."
else
redis:del(max..'lock_yt'..msg.chat_id_)
return "-› أهلا عزيزي "..msg.TheRankCmd.." تم تعطيل اليوتيوب ."
end
end

function unlock_YT(msg)
if not msg.Admin then return "-› هذا الامر يخص (نائب المدير, المدير، المالك) فقط ." end
if redis:get(max..'lock_yt'..msg.chat_id_) then
return "-› أهلا عزيزي "..msg.TheRankCmd.." اليوتيوب شغال بالفعل ."
else
redis:set(max..'lock_yt'..msg.chat_id_,true)
return "-› أهلا عزيزي "..msg.TheRankCmd.." تم تفعيل اليوتيوب ."
end
end

--===================(Qoute tweet)===================--

function lock_qt(msg)
if not msg.Admin then return "-› هذا الامر يخص (نائب المدير, المدير، المالك) فقط ." end
if not redis:get(max..'lock_qt'..msg.chat_id_) then
return "-› أهلا عزيزي "..msg.TheRankCmd.." الكت تويت  بالتأكيد معطل."
else
redis:del(max..'lock_qt'..msg.chat_id_)
return "-› أهلا عزيزي "..msg.TheRankCmd.." تم تعطيل الكت تويت  ."
end
end

function unlock_qt(msg)
if not msg.Admin then return "-› هذا الامر يخص (نائب المدير, المدير، المالك) فقط ." end
if redis:get(max..'lock_qt'..msg.chat_id_) then
return "-› أهلا عزيزي "..msg.TheRankCmd.."الكت تويت  شغال بالفعل."
else
redis:set(max..'lock_qt'..msg.chat_id_,true)
return "-› أهلا عزيزي "..msg.TheRankCmd.." تم تفعيل الكت تويت  ."
end
end
...
function lock_mall(msg)
    if not msg.Director then return "-› هذا الامر يخص (المدير، المالك, المالك الأساسي) فقط ." end
    if not redis:get(max..'lock_mall'..msg.chat_id_) then
        return "-› أهلا عزيزي "..msg.TheRankCmd.."المنشن الجماعي بالتأكيد معطل."
    else
        redis:del(max..'lock_mall'..msg.chat_id_)
        return "-› أهلا عزيزي "..msg.TheRankCmd.." تم تعطيل المنشن الجماعي."
    end
end

function unlock_mall(msg)
    if not msg.Director then return "-› هذا الامر يخص (المدير، المالك, المالك الأساسي) فقط ." end
    if redis:get(max..'lock_mall'..msg.chat_id_) then
        return "-› أهلا عزيزي "..msg.TheRankCmd.."المنشن الجماعي شغال بالفعل ."
    else
        redis:set(max..'lock_mall'..msg.chat_id_,true)
        return "-› أهلا عزيزي "..msg.TheRankCmd.."تم تفعيل المنشن الجماعي."
    end
end

--===================(mall)===================--

function lock_PR(msg)
if not msg.Admin then return "-› هذا الامر يخص المالك فقط ." end
if not redis:get(max..'lock_pr'..msg.chat_id_) then
return "-› أهلا عزيزي "..msg.TheRankCmd.." الحماية بالتأكيد معطلة."
else
redis:del(max..'lock_pr'..msg.chat_id_)
return "-› أهلا عزيزي "..msg.TheRankCmd.." تم تعطيل الحماية ."
end
end

function unlock_PR(msg)
if not msg.Admin then return "-› هذا الامر يخص المالك فقط." end
if redis:get(max..'lock_pr'..msg.chat_id_) then
return "-› أهلا عزيزي "..msg.TheRankCmd.." الحماية مفعلة بالفعل."
else
redis:set(max..'lock_pr'..msg.chat_id_,true)
return "-› أهلا عزيزي "..msg.TheRankCmd.." تم تفعيل الحماية ."
end
end
...
return "-› أهلا عزيزي "..msg.TheRankCmd.."التحذير بالتأكيد معطل."
else
redis:del(max..'lock_woring'..msg.chat_id_)
return "-› أهلا عزيزي "..msg.TheRankCmd.."تم تعطيل التحذير."
end
end

function lock_ID(msg)
if not msg.Director then return "-› هذا الامر يخص (نائب مدير, المدير، المالك، Dev) فقط ." end
if not redis:get(max..'lock_id'..msg.chat_id_) then
return "-› أهلا عزيزي "..msg.TheRankCmd.."الايدي بالتأكيد معطل."
else
redis:del(max..'lock_id'..msg.chat_id_)
return "-› أهلا عزيزي "..msg.TheRankCmd.." تم تعطيل امر الايدي . "
end
end
...
return "-› أهلا عزيزي "..msg.TheRankCmd.." امر الايدي شغال بالفعل . "
else
redis:set(max..'lock_id'..msg.chat_id_,true)
return "-› أهلا عزيزي "..msg.TheRankCmd.." تم تفعيل امر الايدي . "
end
end
...
return "-› أهلا عزيزي "..msg.TheRankCmd.." تفعيل الترحيب مفعل مسبقاً. "
else redis:set(max..'welcome:get'..msg.chat_id_,true)
return "-› أهلا عزيزي "..msg.TheRankCmd.."تم تفعيل الترحيب."
end
end
...
return "-› أهلا عزيزي "..msg.TheRankCmd.." الترحيب بالتأكيد معطل . "
else
redis:del(max..'welcome:get'..msg.chat_id_)
return "-› أهلا عزيزي "..msg.TheRankCmd.." تم تعطيل الترحيب ."
end
end

function lock_All(msg)
if not msg.Director then return "-› هذا الامر يخص (المدير، المالك، Dev) فقط ." end
redis:mset(
...
return "-› أهلا عزيزي "..msg.TheRankCmd.."تم قفل الكل ."
end
...
return "-› أهلا عزيزي "..msg.TheRankCmd.." تم فتح الكل ."
end

function lock_Media(msg)
if not msg.Creator then return "-› هذا الامر يخص (المدير، المالك، Dev) فقط ." end
redis:mset(
max..'mute_gif'..msg.chat_id_,true,
max..'mute_photo'..msg.chat_id_,true,
max..'mute_audio'..msg.chat_id_,true,
...
return "-› أهلا عزيزي "..msg.TheRankCmd.." تم قفل الوسائط ."
end
...
return "-› أهلا عزيزي "..msg.TheRankCmd.." تم فتح الوسائط ."
end
...
if not msg.SudoBase then return "‎-› هذا الامر يخص Myth." end
...
if not msg.Creator then return "‎-› هذا الامر يخص (المالك، المطور و ميث.) فقط ." end
...
if not msg.Admin then return "‎-› هذا الامر يخص (نائب مدير, المدير، المالك، Dev) فقط ." end
