...
قناة أخبار وتحديثات لوسي @rnnni
Myth: @iiiziiii
...
return "حسننا الان ارسل الكليشه للاذاعه للمجموعات ." 
    ...
    if MsgText[1] == 'اصدار السورس' or MsgText[1] == 'الاصدار' then
        return '- اصدار سورس لوسي : *v'..version..'* .'
    end
...
-  يوتيوب, كت تويت, إستجابة سريعه والمزيد ..
- ارفع البوت مشرف بالقروب ثم اكتب كلمة تفعيل .
قناة أخبار وتحديثات لوسي @N00NN0
Myth: @iiiziiii
                ...
                local inline = {{{text="Myth.",url="t.me/"..xsudouser}}}
